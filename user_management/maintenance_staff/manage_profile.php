...
if (!empty($user['hostelID'])) {
    ...
    } catch (Exception $e) { /* Ignore if hostel not found */ }
}
        ...
        <div class="profile-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="staffID" 
                       value="<?= htmlspecialchars($user['staffID'] ?? '-') ?>" 
                       disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="staffRole" 
                       value="<?= htmlspecialchars($user['staffRole'] ?? '-') ?>" 
                       disabled>
            </div>

            <div class="form-group">
                <label for="status">Status:</label>
                <input type="text" id="status" value="<?= htmlspecialchars($user['status'] ?? '-') ?>" disabled>
            </div>

            <div class="form-group">
                <label for="hostel">Assigned Hostel:</label>
                <input type="text" id="hostel" value="<?= htmlspecialchars($hostelName) ?>" disabled>
            </div>
        </div>
